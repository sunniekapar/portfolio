...
const ProjectCard = React.forwardRef<HTMLDivElement, ProjectCardData>(
  (
    {
      imageAlt,
      projectName,
      ...
      <div ref={ref} className="relative group">
        <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-gradient-to-br from-background to-transparent bg-cover">
          <Image
            ...
            width="500"
            height="215"
            className="aspect-[4/3] pointer-events-none min-h-full min-w-full !object-cover duration-300 ease-out scale-100 brightness-90 select-none group-hover:scale-105 group-hover:brightness-[20%]"
          />
        </div>
